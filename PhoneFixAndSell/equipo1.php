    ...
    <div class="principal">
        <div class="form">
            <section>
                ...
                <h2>HUAWEI NOVA 13 PRO</h2>
                <p>COSTO:<b>$10,000</b></p>
                <form method="post">
                    <input style="display:none" type="text" name="modelo" readonly value="nova13pro">
                    <input class="comprarbutton" type="submit" value="COMPRAR">
                </form>
            </section>
            <section></section>
            <div class="formtype"><img src="imagenes/equipos/huaweinova13pro.png" alt=""></div>
        </div>
    </div>
</body>
</html>
