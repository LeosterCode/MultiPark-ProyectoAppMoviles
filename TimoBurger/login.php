...
if (isset($_POST['login'])) {
    ...
    if (!empty($email) && !empty($password)) {
        $login = $cnnPDO->prepare('SELECT * FROM usuarios where email = ? AND password = ?');
        $login->execute([$email, $password]);
        $count = $login->rowCount();
        $fetch = $login->fetch();
        if ($count > 0) {
            $_SESSION['clienteId'] = $fetch['clienteId'];
            ...
            echo 'Correo o contrasena invalidos';
        }
    }
}
?>
...
<head>
    ...
    <title>Inicio Sesion | TimoBurguer</title>
        ...
        <div class="container-fluid" data-bs-theme="dark">
            ...
            <div class="collapse navbar-collapse d-flex me-auto ms-auto" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link mx-2 btnAct" href="login.php">Inicia Sesion</a>
        ...
        <div class="row">
            <div class="col-12 mx-auto text-light">
                <div class="m-2 text-center">
                    <p class="fs-1 text-center text-form">Iniciar Sesion</p>
                ...
                <form method="POST">
                    ...
                    <div class="mb-4">
                        <label class="my-1" for="email">Ingresa tu contrasena:</label>
                        <input class="form-control" type="text" name="password" id="email">
                    </div>
                    <div class="mb-4">
                        <button class="btn btn-danger w-100" type="submit" name="login">
                            Iniciar Sesion
                        </button>
                    </div>
                </form>
