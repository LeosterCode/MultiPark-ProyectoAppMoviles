...
if (isset($_POST['login'])) {
    ...
    if (!empty($email) && !empty($password)) {
        // Buscar usuario por email y contraseña en texto plano
        ...
        if ($usuario) {
            ...
            if ($email === 'raulmtzcortez12@gmail.com') {
        ...
        <tr>
            <td>
                <div class="container mt-5" style="padding: 15px;">
                    ...
                    <br>
                    <button><a href="registrarse.php" style="color: white; text-decoration: none;">No tienes cuenta</a></button>
                </div>
            </td>
        </tr>
    </table>
...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (isset($_SESSION['mensaje'])) {
                list($icon, $title, $text) = explode("|", $_SESSION['mensaje']);
                echo "Swal.fire({icon: '$icon', title: '$title', text: '$text', timer: 2000, showConfirmButton: false});";
